  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
      ...
      <div className="text-center">
        ...
        <div className="text-sm text-black font-medium">Correctes</div>
      </div>
      
      <div className="text-center">
        <div className="text-2xl font-bold text-red-600">{incorrectCards}</div>
        <div className="text-sm text-black font-medium">Incorrectes</div>
      </div>
      ...
      <div className="text-center">
        ...
        <div className="text-sm text-black font-medium">Taux de réussite</div>
      </div>
    </div>
  );
}
